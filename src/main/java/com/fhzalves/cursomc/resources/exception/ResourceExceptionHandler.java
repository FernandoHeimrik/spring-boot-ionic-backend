package com.fhzalves.cursomc.resources.exception;
...
import com.fhzalves.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request){
		...
		for(FieldError x : e.getBindingResult().getFieldErrors()) {            //Percorre a lista de erros da excecao e apresenta o meu objeto FieldMessage
